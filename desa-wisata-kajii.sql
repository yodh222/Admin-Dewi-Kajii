...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Apr 2024 pada 17.51
...
(8, 'Administrator', '0888888888', 'admin@gmail.com', 'asdasdnadisadaiodj', '$2y$12$fkyJDWk8EY9Z8TSEFJNjHeXkaygBMPSchAJ8XqN28MP/hgcMi7ZlG', 'BgaP3KpUgV8sRHP7KxPiZ9obUjUm8u4j4jrvnQBiBHXnLlxTDwYiFq9j5WEZ');
...
(1, 'aasdvaftgdasguyijgkl,mrehbwugvcasw4qwdefrgthyukl45911544|f;lkjhufhsidoa,cv\r\n\r\ni07654edwrsydufm,l./\r\n\\/\r\n\r\n\r\n\\gl;hkmnhbgftwejokrt]h\\j');
...
(1, 'Pembukaan Desa Wisata Kajii ', '2024-03-09', 'DESKRIPSI SINGKAT. Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'https://source.unsplash.com/random');
...
--
ALTER TABLE `tb_ikan_hias`
  MODIFY `id_ikan_hias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tb_kolam_ikan`
  MODIFY `id_kolam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
